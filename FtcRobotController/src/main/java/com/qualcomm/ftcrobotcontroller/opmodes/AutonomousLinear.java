...
public class AutonomousLinear extends OpMode {
    ...
    final PathSeg[] mBeaconPath = {
            new PathSeg(  0.0,  3.0, 0.2),  // Left (leftmotor 0 in., right motor 3 in, 0.2 speed)
    ...
    final double COUNTS_PER_INCH = 229.18 ;    // Number of encoder counts per inch of wheel travel.
